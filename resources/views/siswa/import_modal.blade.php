        ...
        <div class="modal-content">
            <form id="importForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>Pastikan NIM bersifat unik (tidak ada duplikat)</li>
                            <li>Nama kelas harus sesuai dengan kelas yang sudah ada di sistem</li>
                            <li>Username dan Password bersifat opsional</li>
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('siswa.downloadTemplate') }}" class="btn btn-info">
